...
**Test counts:** 637 passing (7 with tolerance overrides), 14 harness tests ignored, 0 unit tests ignored.
...
| BSIM3SOI body voltage / convergence | 2 | Ignored — DD RampVg2 (body collapse in tran), PD inv2 (NR non-convergence) |
