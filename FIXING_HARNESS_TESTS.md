...
**Test counts:** 636 passing (6 with tolerance overrides), 15 harness tests ignored, 0 unit tests ignored.

| Category | Tests | Status |
|---|---|---|
| FP eval order (tolerance override) | 6 | Passing with relaxed rel_tol (CEamp, FG, temp, txl2_3_line, ltra2_2_line, DD t3) |
| VBIC FP eval order (too large) | 1 | Ignored — FO peaks at 15%+ at high bias |
| BSIM3SOI body voltage / convergence | 3 | Ignored — DD RampVg2 (body collapse in tran), DD/PD inv2 (NR non-convergence) |
