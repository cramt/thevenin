...
## Current status of all remaining ignored tests (as of 2026-03-30, session 85)
...
All 34 remaining harness tests were re-tested in this session — none have improved enough to pass. Session 85 confirmed that Gme (back-gate transconductance) implementation in DD does NOT change converged DC results, proving the 0.63% DD t3 error is from body current equations not Jacobian quality.
